    ...
    <div class="flex items-center gap-5">
        <div>
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search" class="block w-[240px] ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-[#242427] bg-gray-50 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required>
            </div>
        </div>
        <livewire:theme-btn />
    </div>
